    ...
    <div class="login-bg">
        ...
        <div class="glass-container">
            ...
            <div class="panel left">
                <h2 class="text-white">Đăng nhập - Nhà hàng</h2>
            ...
            <div class="panel right">
                ...
                <p>Nhập thông tin nhà hàng và bắt đầu hợp tác với chúng tôi</p>
                <button class="sign-up-btn" @click="router.push('/restaurant/register')">Đăng ký</button>
            </div>
        </div>
    </div>
</template>
...
async function handleLogin() {
    ...
    loading.value = true
    try {
        const data = await login(email.value, mat_khau.value, 'restaurant')
