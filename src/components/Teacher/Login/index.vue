    ...
    <div class="login-bg">
        ...
        <div class="glass-container">
            ...
            <div class="panel left">
                <h2 class="text-white">Đăng nhập - Giáo viên</h2>
            ...
            <div class="panel right">
                ...
                <p>Nhập thông tin cá nhân và bắt đầu hành trình giảng dạy với chúng tôi</p>
                <button class="sign-up-btn" @click="router.push('/teachers/register')">Đăng ký</button>
            </div>
        </div>
    </div>
</template>
...
async function handleLogin() {
    ...
    loading.value = true
    try {
        const data = await login(email.value, mat_khau.value, 'teacher')
        ...
        const msg = err?.response?.data?.message || err?.message || err || 'Đăng nhập thất bại'
