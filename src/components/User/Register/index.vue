        ...
        <div class="glass-container">
            ...
            <div class="panel left">
                ...
                <form @submit="handleRegister">
                    <input type="text" placeholder="Họ và tên" v-model="ho_ten" required />
            ...
            <div class="panel right">
                ...
                <button class="sign-up-btn" @click="router.push('/user/login')">Đăng nhập</button>
            </div>
        </div>
    </div>
</template>
...
async function handleRegister(e) {
    ...
    loading.value = true
    try {
        const data = await register(ho_ten.value, email.value, mat_khau.value)
        if (data.status) {
